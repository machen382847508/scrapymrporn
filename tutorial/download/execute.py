...
if __name__ == '__main__':
    ...
    nonporn = DButils().get_non_download()
    ...
    preporn = DButils().update_get_pre_download(nonporn.pornid)
    t1 = threading.Thread(target=file1.downfile, args=(str(ADDRESS+filename),preporn.pornid))
    t1.start()
